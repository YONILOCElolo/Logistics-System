...
<div align="center">
	<form action="Tag2Servlet">
		<br/><br/><br/><br/><br/>
		<div class="bold">	该客户点的距离超过货车所能形式的最大距离</div>
		<br/>
		<div class="style"> 请点击继续重新输入</div> <br/>
		<input type="submit" class="ctn" name="page2_cfail" value="点击继续"></br>
	</form>
</div>
