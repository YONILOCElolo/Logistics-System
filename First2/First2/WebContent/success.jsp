		...
		<div id="content">
			<div align="center">
				...
				<form action="Tag2Servlet">
					...
					<br/><br/><br/>
					<input type="submit" class="ctn" name="page3" value="点击继续"></br>
					<%-- <input type="submit" onclick="javascript:this.form.action='Tab.jsp';" value="结束添加">--%>
					<input type="submit" class="ctn" name="page3" value="结束添加">
				</form>
			</div>
		</div>
	</div>
